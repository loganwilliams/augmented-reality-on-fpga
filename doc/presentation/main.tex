...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{arbiskew_graphic_with_iterators0.png}
	\end{figure}
	\begin{enumerate}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{arbiskew_graphic_with_iterators1.png}
	\end{figure}
	\begin{enumerate}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{arbiskew_graphic_with_iterators2.png}
	\end{figure}
	\begin{enumerate}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{arbiskew_graphic_with_iterators3.png}
	\end{figure}
	\begin{enumerate}
	\item[11] Move $I_A$ along line $\overline{A\prime D\prime}$ by an amount $= \frac{d_{ad}}{height_{original}}$.
	\item[12] Move $I_B$ along line $\overline{B\prime C\prime}$ by an amount $= \frac{d_{bc}}{height_{original}}$.
